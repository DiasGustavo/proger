...
public class ArquivoDAO {
	...
	public List<Arquivo> listar(){
		...
		try{
			Query consulta = sessao.getNamedQuery("Arquivo.listar");
	...
	@SuppressWarnings("unchecked")
	public List<Arquivo> buscarListaPorCodigo(Long codigo){
		Session sessao = HibernateUtil.getSessionFactory().openSession();
	...
	@SuppressWarnings("unchecked")
	public Set<Arquivo> buscarListaSetPorCodigo(Long codigo){
		Session sessao = HibernateUtil.getSessionFactory().openSession();
