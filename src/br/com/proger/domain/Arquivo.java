...
@Entity
@Table(name = "tbl_arquivo", uniqueConstraints = {
        @UniqueConstraint(columnNames = "id_arquivo")})
@NamedQueries({
	...
	@NamedQuery(name = "Arquivo.buscarArquivos", query = "SELECT arquivo FROM Arquivo arquivo  JOIN arquivo.acao acao WHERE acao.id =:codigo")
})
public class Arquivo implements Serializable{
	...
	public Set<Acao> getAcao() {
		return acao;
	}

	public void setAcao(Set<Acao> acao) {
		this.acao = acao;
	}
